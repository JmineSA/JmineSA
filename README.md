# Lesiba Kganyago – Data Scientist

**Specialty:** Predictive modeling for revenue optimization + customer retention  
**Open to:** Data Science roles (fintech, retail, healthcare, operations)
